        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tickets" className="text-green-100 hover:text-white transition-colors text-sm">
                  Book Tickets
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/partner" className="text-green-100 hover:text-white transition-colors text-sm">
                  Become a Partner
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-green-100 hover:text-white transition-colors text-sm">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-green-100 hover:text-white transition-colors text-sm">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/booking-guide" className="text-green-100 hover:text-white transition-colors text-sm">
                  Booking Guide
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/refund" className="text-green-100 hover:text-white transition-colors text-sm">
                  Refund Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link href="/sitemap" className="text-green-200 hover:text-white text-sm transition-colors">
                Sitemap
              </Link>
              <Link href="/accessibility" className="text-green-200 hover:text-white text-sm transition-colors">
                Accessibility
              </Link>
              <Link href="/cookies" className="text-green-200 hover:text-white text-sm transition-colors">
                Cookies
              </Link>
            </div>
          </div>
