...
//           console.log("Retrieved bookingCode:", bookingCode);
//           if (bookingCode) {
//             localStorage.removeItem("bookingCode");
//             console.log("Redirecting to:", `/bookingresult/${bookingCode}`);
//             router.push(`/bookingresult/${bookingCode}`);
//             return;
//           } else {
//             console.error("Missing bookingCode in localStorage");
//             router.push("/error?message=Missing booking information");
//             return;
//           }
//         } else {
