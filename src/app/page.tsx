...
const Home = async () => {
  ...
  return (
    <div className="h-full w-full bg-primary">
      ...
      <div className="py-4 z-30 h-screen flex flex-col items-center justify-evenly">
      ...
      <section className="grid grid-cols-3 justify-center gap-6 w-full max-w-6xl mx-auto py-16 px-4 ">
