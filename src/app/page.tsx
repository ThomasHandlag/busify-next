          ...
          <Card className="bg-gradient-to-r from-green-600 to-green-700 text-white border-0 mt-16">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg text-green-100">
                ...
                Simple contract process, competitive rates, and dedicated
                support.
              </CardDescription>
            </CardHeader>
                ...
                <TabsContent value="providers" className="space-y-8">
                  <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <Card className="text-center">
                      ...
                      <CardContent>
                        <CardDescription>
                          Configure your routes, pricing, and schedules. Our
                          team helps you launch your services on the platform.
                        </CardDescription>
                      </CardContent>
                    </Card>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card className="border-green-200">
                  ...
                  <CardContent>
                    <CardDescription className="mb-4">
                      Streamlined booking for employee business trips with
              ...
              <FadeinWrapper effect="animate-fade-in-l300">
                <Card className="border-green-200">
                  ...
                  <CardContent>
                    <CardDescription className="mb-4">
                      Special rates and coordinated travel for groups, events,
                      and tour operators.
                    </CardDescription>
                    <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Yes, you can cancel or modify your booking up to a certain
                  time before departure (varies by provider). Cancellation fees
                  may apply according to the provider&apos;s policy.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  ...
                  changes to your trip. In case of significant delays, you may
                  be eligible for compensation according to our passenger
                  protection policy.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
        ...
        <section className="py-16 bg-green-700 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-green-100 mb-8">
              Get the latest deals, new routes, and travel tips delivered to
              your inbox.
            </p>
